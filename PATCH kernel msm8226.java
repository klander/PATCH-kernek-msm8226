PATCH msm8226: Add UltraKSM 0.1.2.3
...
@@ -1176,7 +1177,7 @@ void setup_new_exec(struct linux_binprm * bprm)
           group */
...
@@ -1286,8 +1287,8 @@ static int check_unsafe_exec(struct linux_binprm *bprm)
        return res;
 }
...
index 696b7d8..1b53adad 100644
--- a/include/linux/mm_types.h
+++ b/include/linux/mm_types.h
@@ -262,6 +262,9 @@ struct vm_area_struct {
 #ifdef CONFIG_NUMA
...
+#endif
 ...
 /*
@@ -797,7 +800,7 @@ static inline int is_normal_idx(enum zone_type idx)
 }
...
index 361b06b..d91e43f 100644
--- a/kernel/fork.c
+++ b/kernel/fork.c
@@ -378,7 +378,7 @@ static int dup_mmap(struct mm_struct *mm, struct mm_struct *oldmm)
                                goto fail_nomem;
                        charge = len;
                }
...
index ccecbf9..2056f9b 100644
--- a/mm/Makefile
+++ b/mm/Makefile
@@ -33,7 +33,8 @@ obj-$(CONFIG_SPARSEMEM)       += sparse.o
...
+
  ...
  */
@@ -125,6 +156,7 @@ static int __init init_zero_pfn(void)
...
@@ -726,8 +758,10 @@ static inline int is_cow_mapping(vm_flags_t flags)
 #ifndef is_zero_pfn
...
+#define is_zero_pfn(pfn)   (is_zero_pfn(pfn) || is_uksm_zero_pfn(pfn))
 ...
 #ifndef my_zero_pfn
@@ -913,6 +947,11 @@ copy_one_pte(struct mm_struct *dst_mm, struct mm_struct *src_mm,
                        rss[MM_ANONPAGES]++;
                else
                        rss[MM_FILEPAGES]++;
+
...
+                       }
                        if (unlikely(details) && details->nonlinear_vma
                            && linear_page_index(details->nonlinear_vma,
                                                addr) != page->index)
@@ -1675,7 +1716,7 @@ int __get_user_pages(struct task_struct *tsk, struct mm_struct *mm,
...
+       /*
         ...
         */
@@ -1722,7 +1763,7 @@ int __get_user_pages(struct task_struct *tsk, struct mm_struct *mm,
...
+                                           (is_zero_pfn(pte_pfn(*pte))))
                                                ...
                                                pte_unmap(pte);
@@ -2542,8 +2583,10 @@ static inline void cow_user_page(struct page *dst, struct page *src, unsigned lo
                        clear_page(kaddr);
                kunmap_atomic(kaddr);
...
@@ -501,9 +503,16 @@ int vma_adjust(struct vm_area_struct *vma, unsigned long start,
        long adjust_next = 0;
        int remove_next = 0;
...
@@ -579,10 +588,10 @@ again:                    remove_next = 1 + (end > next->vm_end);
                if (adjust_next)
...
@@ -635,10 +644,15 @@ again:                    remove_next = 1 + (end > next->vm_end);
                 */
                if (remove_next == 2) {
                        next = vma->vm_next;
+                       uksm_remove_vma(next);
...
+       uksm_vma_add_new(vma);
        ...
        return 0;
@@ -1006,6 +1020,9 @@ static unsigned long do_mmap_pgoff(struct file *file, unsigned long addr,
...
+       uksm_vma_add_new(vma);
        ...
        if (correct_wcount)
@@ -1383,6 +1401,7 @@ unmap_and_free_vma:
...
+#endif
 ...
 {
@@ -2012,6 +2031,8 @@ static int __split_vma(struct mm_struct * mm, struct vm_area_struct * vma,
        else
...
+
        ...
        if (!err)
                return 0;
@@ -2185,6 +2206,7 @@ static unsigned long do_brk(unsigned long addr, unsigned long len)
                return error;
...
+       uksm_vm_flags_mod(&flags);
        ...
        if (error & ~PAGE_MASK)
@@ -2253,6 +2275,7 @@ static unsigned long do_brk(unsigned long addr, unsigned long len)
        vma->vm_flags = flags;
...
@@ -2285,6 +2308,12 @@ void exit_mmap(struct mm_struct *mm)
...
+
        if (mm->locked_vm) {
                vma = mm->mmap;
                while (vma) {
@@ -2318,6 +2347,11 @@ void exit_mmap(struct mm_struct *mm)
        while (vma)
                vma = remove_vma(vma);
...
@@ -2427,6 +2461,7 @@ struct vm_area_struct *copy_vma(struct vm_area_struct **vmap,
...
+                       uksm_vma_add_new(new_vma);
        ...
        return new_vma;
@@ -2532,10 +2567,10 @@ int install_special_mapping(struct mm_struct *mm,
...
index aa95e59..a3a2f57 100644
--- a/mm/rmap.c
+++ b/mm/rmap.c
@@ -1006,9 +1006,9 @@ void page_move_anon_rmap(struct page *page,
...
index cec1553..32f8279 100644
--- a/mm/vmstat.c
+++ b/mm/vmstat.c
@@ -726,6 +726,9 @@ const char * const vmstat_text[] = {
 #endif
        "nr_anon_transparent_hugepages",
        "nr_free_cma",
+#ifdef CONFIG_UKSM
...
From a593a8ce7b92a1ed6d5d0ca7b7172e62b00bb58a Mon Sep 17 00:00:00 2001
From: luca020400 <luca.stefani.ge1@gmail.com>
Date: Wed, 6 May 2015 11:56:41 +0200
Subject: [PATCH 2/2] falcon peregrine titan: enable UKSM
 
Change-Id: Ia4b1b308d6edeb4612126370f52915586d3edaf6
---
arch/arm/configs/falcon_defconfig    | 3 ++-
 arch/arm/configs/peregrine_defconfig | 3 ++-
 arch/arm/configs/titan_defconfig     | 3 ++-
 3 files changed, 6 insertions(+), 3 deletions(-)
 
diff --git a/arch/arm/configs/falcon_defconfig b/arch/arm/configs/falcon_defconfig
index e730f06..aa8a4eb 100644
--- a/arch/arm/configs/falcon_defconfig
+++ b/arch/arm/configs/falcon_defconfig
@@ -643,7 +643,8 @@ CONFIG_MIGRATION=y
...
diff --git a/arch/arm/configs/peregrine_defconfig b/arch/arm/configs/peregrine_defconfig
index 62394a9..bc4a280 100644
--- a/arch/arm/configs/peregrine_defconfig
+++ b/arch/arm/configs/peregrine_defconfig
@@ -643,7 +643,8 @@ CONFIG_MIGRATION=y
 CONFIG_ZONE_DMA_FLAG=0
 CONFIG_BOUNCE=y
 CONFIG_VIRT_TO_BUS=y
...
+CONFIG_UKSM=y
 ...
 # CONFIG_CLEANCACHE is not set
 CONFIG_MEMORY_HOLE_CARVEOUT=y
diff --git a/arch/arm/configs/titan_defconfig b/arch/arm/configs/titan_defconfig
index 7dd46db..36de795 100644
--- a/arch/arm/configs/titan_defconfig
+++ b/arch/arm/configs/titan_defconfig
@@ -643,7 +643,8 @@ CONFIG_MIGRATION=y
 CONFIG_ZONE_DMA_FLAG=0
 CONFIG_BOUNCE=y
 CONFIG_VIRT_TO_BUS=y
